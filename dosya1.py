...
class MetroAgi:
    ...
    def en_az_aktarma_bul(self, baslangic_id: str, hedef_id: str) -> Optional[List[Istasyon]]:
        ...
        ziyaret_edildi = set([baslangic])  # Ziyaret edilen istasyonlar
        ...
        return None  # Hedefe ulaşmak mümkün değilse
    ...
    def en_hizli_rota_bul(self, baslangic_id: str, hedef_id: str) -> Optional[Tuple[List[Istasyon], int]]:
        ...
        while pq:
            ...
            if istasyon == hedef:
                return (rota, toplam_sure)  # Hedefe ulaşıldığında rota ve süre döndürülür
